...
int main(int argc, char* argv[]) {
    ...
    while (true) {
        ...
        printf("ipv4_src_IP :%s \n", inet_ntoa(ip_hdr->ip_src));
        printf("ipv4_dst_IP :%s \n", inet_ntoa(ip_hdr->ip_dst));
        ...
        //char payload[10];
        unsigned char *data = packet + sizeof(struct libnet_ethernet_hdr) +sizeof(struct libnet_ipv4_hdr)+ sizeof(struct libnet_tcp_hdr);
